...
def run_agent_orchestrator():
    ...
    while True:
        ...
        print("[Agent]: Triggering Perception Module (Input Extraction)...")
        ...
        print("[Agent]: Triggering Action Module (Fetching Live OpenWeather JSON)...")
        ...
        print("[Agent]: Routing raw response to Perception Module for decoding...")
        ...
        print(f"[Agent Filtered Observation]: {interpreted_observation}")
        ...
        if "Error" in interpreted_observation:
            clarification_question = f"The weather service failed: {interpreted_observation}. Please try another city."
        ...
        print("[Agent]: Sending interpreted data to Brain for synthesis...")
        ...
        execute_action("response_user", {"message": final_human_answer})
